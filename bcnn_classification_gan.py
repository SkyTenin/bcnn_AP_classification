...
if __name__ ==  '__main__':
    ...
    np.save('bcnn_classification_gan_AP_feat_array.npy', np.hstack(res_arr))
    np.save('bcnn_classification_gan_AP_real_array.npy', np.hstack(label_arr))
    np.save('bcnn_classification_gan_AP_score_array.npy', np.hstack(score_arr))
